...
public class StringCalculator {
    public int Add(String numbers){
        String delimiter = ",|\n", negative_num_str = "", split_numbers[];
        ArrayList<Integer> negative_numbers = new ArrayList<>();

        numbers = numbers.replaceAll(" ", "");  // Method will Removing Spaces
        ...
        for (String n : split_numbers) {
            ...
            if (current < 0) {
                ...
                negative_num_str += (String.valueOf(current) + " ");
            }
        ...
        NegativeNumException.throwExceptionIfNegativeExists(negative_num_str);
        return total;
    }
}